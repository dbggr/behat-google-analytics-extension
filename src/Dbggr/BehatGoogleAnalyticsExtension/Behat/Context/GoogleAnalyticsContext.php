<?php
namespace Dbggr\BehatGoogleAnalyticsExtension\Behat\Context;
...
class GoogleAnalyticsContext extends RawMinkContext implements GoogleAnalyticsAwareInterface
{
    ...
    * @var array
    */
    protected $googleAnalyticsParameters = [];
    ...
    */
    ...
    public function googleAnalyticsTracksAPageviewOn($arg1)
    {
        ...
        throw new \Exception('Page view not tracked');
    }
    ...
    */
    public function generateIdentificationUriParam()
    {
        ...
        $this->setGoogleAnalyticsParameter(
            'appendToUrl',
            'utm_source=behat&utm_medium=test&utm_campaign=' .
            $this->getGoogleAnalyticsParameter('identificationHash'));
    ...
    * @return \Google_Service_Analytics_Realtime Data
    */
    protected function queryGoogleAnalytics($dimensions = '', $filters = '')
    {
        ...
        return $this->analyticsApiService
            ->data_realtime->get(
                'ga:' . $this->getGoogleAnalyticsParameter('view'),
                'rt:activeUsers',
                $queryOptions
            );
    }
