<?php
namespace Dbggr\BehatGoogleAnalyticsExtension\Behat\Context\Initializer;

use Behat\Behat\Context\Context;
use Behat\Behat\Context\Initializer\ContextInitializer;
use Dbggr\BehatGoogleAnalyticsExtension\Behat\Context\GoogleAnalyticsAwareInterface;
